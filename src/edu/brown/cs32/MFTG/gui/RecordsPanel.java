...
public class RecordsPanel extends JPanel{
	...
	private ImagePanel _recordsLite, _backLite, _backDark, _viewLite, _viewDark, _viewGrey;
	private BufferedImage _background;
	private Point _recordsLoc,  _backLoc, _viewLoc;
	...
	public RecordsPanel(MonopolyGui main) {
		try {
			...
			_viewGrey = new ImagePanel(Helper.resize(ImageIO.read(new File("images/ViewGrey.png")), 110, 50));
			_viewLoc= new Point(this.getWidth()-_viewLite.getWidth()-30, this.getHeight()-_viewLite.getHeight()-20);
			_viewLite.setLocation(_viewLoc);
			_viewDark.setLocation(_viewLoc);
			_viewGrey.setLocation(_viewLoc);
