...
public class Constants {
	...
	public final static int BORDER = (int) 1;
	...
	public enum ColorProperties implements Properties {
		...
		NEW_YORK_AVENUE(Orientation.LEFT, PropertyColor.ORANGE, "New York Avenue", "Deed_Cards/new_york_avenue.jpg", "new york aveune"),
		...
		MARVIN_GARDENS(Orientation.UP, PropertyColor.YELLOW, "Marvin Gardens", "Deed_Cards/marvin_gardens.jpg", "martvin gardens"),
