...
public class Board {
	...
	public Board(Game game) {
		...
		_allProperties.add(_board[1].getProperty());
		...
		_allProperties.add(_board[3].getProperty());
		...
		_allProperties.add(_board[5].getProperty());
		...
		_allProperties.add(_board[6].getProperty());
		...
		_allProperties.add(_board[8].getProperty());
		...
		_allProperties.add(_board[9].getProperty());
		...
		_allProperties.add(_board[13].getProperty());
		...
		_allProperties.add(_board[14].getProperty());
		...
		_allProperties.add(_board[15].getProperty());
		...
		_allProperties.add(_board[16].getProperty());
		...
		_allProperties.add(_board[18].getProperty());
		...
		_allProperties.add(_board[19].getProperty());
		...
		_allProperties.add(_board[21].getProperty());
		...
		_allProperties.add(_board[23].getProperty());
		...
		_allProperties.add(_board[24].getProperty());
		...
		_allProperties.add(_board[25].getProperty());
		...
		_allProperties.add(_board[26].getProperty());
		...
		_allProperties.add(_board[29].getProperty());
		...
		_allProperties.add(_board[31].getProperty());
		...
		_allProperties.add(_board[32].getProperty());
		...
		_allProperties.add(_board[34].getProperty());
		...
		_allProperties.add(_board[35].getProperty());
		...
		_allProperties.add(_board[37].getProperty());
		...
		_allProperties.add(_board[39].getProperty());
