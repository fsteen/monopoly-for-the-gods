...
public class BackendConstants {
	...
	public static final int DEFAULT_GAMES_PER_SET=10000; //the GUI starts out showing this many games
	public static final int DEFAULT_TIME_BEGIN=180; //the GUI starts out showing this much time to choose heuristics the first time
	public static final int DEFAULT_TIME_BETWEEN=180; //the GUI starts out showing this much time to choose heuristics subsequent times
