...
public class BackendConstants {
	...
	public static final int DEFAULT_TIME_BEGIN=60; //the GUI starts out showing this much time to choose heuristics the first time
	public static final int DEFAULT_TIME_BETWEEN=60; //the GUI starts out showing this much time to choose heuristics subsequent times
